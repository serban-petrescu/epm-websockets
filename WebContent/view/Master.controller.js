...
sap.ui.core.mvc.Controller.extend("epmwebsockets.view.Master", {
	...
	loadDetailView : function(){
		this.getRouter().myNavToWithoutHash({ 
			...
			targetViewName : "epmwebsockets.view.Detail",
			targetViewType : "XML"
		});
	},
    ...
    createEntity: function() {
        if (!this.dialog) {
            ...
            this.dialog.setTitle(i18n.getText("createDialogTitle"));
        }
    ...
    onDialogAcceptButton: function() {
        this.getOwnerComponent().getModel().create("/Products/", {
            Name: this.byId("dialogInput1").getValue(),
            Description: this.byId("dialogInput2").getValue(),
            Price: this.byId("dialogInput3").getValue()
        }, {
            success: jQuery.proxy(function() {
        		this.getRouter().navTo("detail", {entity: "Products('"
        		    + this.byId("dialogInput1").getValue() + "')"});
                this.dialog.close();
        	}, this),
            error: showError
        });
